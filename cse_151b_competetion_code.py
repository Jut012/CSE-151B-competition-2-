# -*- coding: utf-8 -*-
"""CSE_151B_Competetion_Code (starter code for Colab).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1aA8NhQCSw1GJSwlmiXq2gbOwOnM9yw1H
...
config["data"]["path"] = "/content/processed_data_cse151b_v2_corrupted_ssp245/processed_data_cse151b_v2_corrupted_ssp245.zarr"
...
!mv submissions/kaggle_submission_20250517_054937.csv submission_simplecnn.csv

from google.colab import files
files.download('submission_simplecnn.csv')

pip install nbstripout

!pip install nbstripout
!nbstripout "CSE_151B_Competetion_Code_(starter_code_for_Colab).ipynb"

from google.colab import drive
drive.mount('/content/drive')

import pandas as pd
df = pd.read_csv("submissions/kaggle_submission_20250517_054937.csv")
print("Submission shape:", df.shape)

!zip -r milestone_final_package_CNN_startingplace.zip submissions/ val_preds.npy val_trues.npy *.ipynb
...
from google.colab import files
files.download("sample_input_output.png")
